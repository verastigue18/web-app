<link rel="stylesheet" href="../assets/styles/addNewOrder.css">

<div class="modal-background" id="modalFull">
    <div class="wrapper">
    <div class="wrapper-block">
        ...
        <div class="buttons">
            ...
            <button class="btn btn-background" id="submit-btn">Create Order</button>
        </div>
    </div>
    </div>
</div>
